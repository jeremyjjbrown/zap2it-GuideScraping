...
def buildXMLProgram(event, channelId, optLanguage):
...
def main():
    ...
    createXML(optConfigFile, optGuideFile, optLanguage)


def createXML(optConfigFile, optGuideFile, optLanguage):
    ...
    while(closestTimestamp < endTimestamp):
        ...
        for channel in guide["channels"]:
            ...
            for event in channel["events"]:
                programXML = programXML + buildXMLProgram(event, channel["channelId"], optLanguage)
        addChannels = False
